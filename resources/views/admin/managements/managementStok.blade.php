          ...
          <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex justify-content-between align-item-center">
              ...
              <div class="d-flex justify-content-start flex-column ml-1">
                <small class="font-weight-bold" id="nameProduct">Tes</small>
                <small class="text-muted" id="kodeProduct">123</small>
              </div>
            </div>
            <div class="d-flex justify-content-end align-items-end flex-column ml-1">
              <small class="text-muted"><span id="hargaDasar">Rp. 1.000</span></small>
              <small class="badge badge-success" id="stokProduct">100</small>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <button class="btn btn-sm btn-outline-primary btn-block" id="showStok">Lihat Stok</button>
            </div>
          </div>
        </div>
      </div>
