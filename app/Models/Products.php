...
{
    protected $fillable = ['suplier_id', 'cabang_id', 'nama_barang', 'type_barang', 'harga_dasar', 'harga_jual', 'stok', 'selled', 'kategori_id', 'berat', 'satuan', 'diskon', 'rak', 'keterangan', 'point', 'isRetail', 'jumlah', 'jumlahEceranPermanent', 'harga_satuan'];
