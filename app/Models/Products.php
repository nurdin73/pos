...
{
    protected $fillable = ['suplier_id', 'nama_barang', 'type_barang', 'kode_barang', 'harga_dasar', 'harga_jual', 'stok', 'selled', 'kategori_id', 'berat', 'satuan', 'diskon', 'rak', 'keterangan', 'point'];
